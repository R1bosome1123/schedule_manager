...
#include <memory>
#include "../../../include/register_window.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Register_Window_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Register_Window_t qt_meta_stringdata_Register_Window = {
    {
        QT_MOC_LITERAL(0, 15),  // "Register_Window"
        QT_MOC_LITERAL(16, 17),  // "onRegisterClicked"
        QT_MOC_LITERAL(34, 0)   // ""
    },
    "Register_Window",
    "onRegisterClicked",
...
Q_CONSTINIT static const uint qt_meta_data_Register_Window[] = {
...
Q_CONSTINIT const QMetaObject Register_Window::staticMetaObject = { {
    ...
    qt_meta_stringdata_Register_Window.offsetsAndSizes,
    qt_meta_data_Register_Window,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Register_Window_t,
        // Q_OBJECT / Q_GADGET
